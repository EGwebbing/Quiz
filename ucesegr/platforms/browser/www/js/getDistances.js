...
// This function calculates user distances from each point of interest. It uses a search radius of 10 meters to index the distance and displays the appropriate POI question.
...
// The function verifies the user answer and uploads the points to the database.
// This script is similar to the one used to upload the data onto the database from the WebApp.
...
// variable that verifies if the answer is correct and uploads it
var client;
...
// response of the data server and create the code to wait for the response from the data server, and process the response once it is received
function dataUploadedAnswer() {
	//this function listens out for the server to say that the data is ready - i.e. has state 4
	if (client.readyState == 4) {
		// make an alert to show the response and set a time refresh of 60 sec
